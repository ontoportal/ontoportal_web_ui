...
function autoSearch() {
  ...
  var params = BP_queryString(), query = null, ontologyIds = null, categories = null;
...
function aggregateResultsByOntologyWithClasses(results, classes) {
  ...
  ont = null, cls = null, res = null, ont_owner = null;
...
function resultsByOntologyArray(ontologies){
  var resultsByOntology = [], ont = null;
...
function aggregateResultsByClassURI(results) {
  var cls_hash = {}, res = null, cls_id = null;
  for (var r in results) {
    res = results[r];
    cls_id = res['@id'];
...
function formatAdditionalClsResults(clsResults, ontAcronym) {
  var additionalClsTitle = null, clsResultsFormatted = null, searchResultDiv = null, classLabelDiv = null, classDetailsDiv = null;
...
function formatAdditionalOntResults(ontResults, ontAcronym) {
  var additionalOntTitle = null, ontResultsFormatted = null, searchResultDiv = null, classLabelDiv = null, classDetailsDiv = null;
...
function updatePopupCounts() {
  var ontologies = [], result = null, resultsCount = 0;
...
function classLabelSpan(cls) {
  ...
  // if necessary.
  var MAX_LENGTH = 60, labelText = cls.prefLabel, labelSpan = null;
...
function filterCategories(results, filterCats) {
  var newResults = [], result = null, acronym = null;
...
function shortenDefinition(def) {
  var defLimit = 210, defWords = null;
...
function advancedOptionsSelected() {
  var selected = null, check = null, i = null, j = null;
...
function classDiv(res, clsLabel, displayOntologyName) {
  var clsID = null, clsCode = null, clsURI = null, ontAcronym = null, ontName = null, clsAttr = null, clsAnchor = null, clsIdDiv = null;
  ontAcronym = ontologyIdToAcronym(res.links.ontology);
  clsID = res["@id"];
  clsCode = encodeURIComponent(clsID);
...
function resultLinksSpan(res) {
  var ontAcronym = null, clsID = null, clsCode = null, detailsAttr = null, detailsAnchor = null, vizAttr = null, vizAnchor = null, resLinks = null;
  ontAcronym = ontologyIdToAcronym(res.links.ontology);
  clsID = res["@id"];
  clsCode = encodeURIComponent(clsID);
