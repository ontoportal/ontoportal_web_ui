...
function setup_functions(){
	...
	jQuery("input[class*='bp_form_complete']").each(function(){
		...
		jQuery(this).autocomplete("http://bioportal.bioontology.org/search/json_search/"+ontology_id, { extraParams:{'target':target_property},lineSeparator:"~!~",matchSubset:0,minChars:3,maxItemsToShow:20,formatItem:formatItem });	
	});
