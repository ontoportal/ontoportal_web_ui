class OntologiesController < ApplicationController
  ...
  def summary
    ...
    @submissions = @ontology.explore.submissions({include: "submissionId,creationDate,released,submissionStatus,hasOntologyLanguage"}).sort {|a,b| b.submissionId.to_i <=> a.submissionId.to_i } || []
