...
Rails.application.configure do
  ...
  # Tells Rails to use the letter_opener_web gem to “deliver” emails in development by opening them in the browser,
  # rather than actually sending them.
  config.action_mailer.delivery_method = :letter_opener_web

  # Tells the letter_opener gem to save the generated email HTML files to a specific directory — in this case,
  # tmp/my_mails — rather than the default tmp/letter_opener.
